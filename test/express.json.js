...
describe("express.json()", function () {
  ...
  it("should handle no message-body", function (done) {
    request(
      createApp({}, (body) => {
        console.log("no message-body", typeof body);
      })
    )
      .post("/")
      .set("Content-Type", "application/json")
  ...
  it("should 400 when only whitespace", function (done) {
    request(createApp())
      ...
      .set("Content-Type", "application/json")
      .send("  \n")
      .expect(400, "[entity.parse.failed] " + parseError(" "), (err, res) => {
  ...
  describe("with inflate option", function () {
    ...
    describe("when true", function () {
      ...
      it("should accept content-encoding", function (done) {
        ...
        test.expect(200, '{"name":"论"}', (err, res) => {
          console.log(res.text);
          done();
        });
      });
    ...
    describe("when undefined", function () {
      ...
      it("should 400 on primitives", function (done) {
        request(this.app)
          ...
          .expect(
            400,
            "[entity.parse.failed] " + parseError("#rue").replace("#", "t"),
            done
          );
      });
    });
  ...
  describe("charset", function () {
    ...
    it("should parse when content-length != char length", function (done) {
      ...
      let buf = Buffer.from("7b2274657374223a22c3a5227d", "hex");
